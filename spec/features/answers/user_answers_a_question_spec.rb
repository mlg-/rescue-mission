...
# - I must be presented with errors if I fill out the form incorrectly
  ...
  scenario 'user offers two answers, which should appear in chronological order' do
    user = FactoryGirl.create(:user)
    ...
    fill_in('Your Answer', with: "Sartre uses the term ‘Foucaultist power relations’ to denote the common ground between sexual identity and class. Therefore, an abundance of theories concerning not, in fact, narrative, but neonarrative may be revealed.")
    click_button("Save the day!")

    expect(page.body.index("The main theme")).to be < page.body.index("Sartre uses the term")
